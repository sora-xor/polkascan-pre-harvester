...
class BlockTotalProcessor(BlockProcessor):
    ...
    def sequencing_hook(self, db_session, parent_block_data, parent_sequenced_block_data):
        ...
        self.sequenced_block.total_bridge_income = int(parent_sequenced_block_data.get('total_bridge_income', 0)) + self.block.count_bridge_income
        self.sequenced_block.total_bridge_outcome = int(parent_sequenced_block_data.get('total_bridge_outcome', 0)) + self.block.count_bridge_outcome
