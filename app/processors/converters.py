...
class PolkascanHarvesterService(BaseService):
    ...
    def process_metadata(self, spec_version, block_hash):
        ...
        if runtime:
            ...
            try:
                ...
                pass
            try:
                print('264', self.substrate.metadata_decoder.value['V12']['modules'])
            except Exception:
                pass
            try:
                print('268', self.substrate.metadata_decoder.get_metadata().modules)
            except Exception:
                pass
            try:
                print('272', self.substrate.metadata_decoder.get_metadata()['V12'])
            except Exception:
                pass
            try:
                print('276', self.substrate.metadata_decoder.get_metadata()['V12']['modules'])
            except Exception:
                pass
            try:
                print('280', self.substrate.metadata_decoder.get_metadata().value['V12']['modules'])
            except Exception:
                pass
            try:
                print('284', self.substrate.metadata_decoder.get_metadata())
            except Exception:
                pass
            try:
                print('288', dir(self.substrate.metadata_decoder.get_metadata()))
            except Exception:
                pass
            try:
    ...
    def add_block(self, block_hash):
        ...
        try:
            print('597 type_registry: %s' % self.substrate.type_registry.items())
            ...
            try:
                ...
                print('604 type_registry: %s' % self.substrate.type_registry.items())
                raise
        ...
        for extrinsic in extrinsics_data:
            ...
            model = Extrinsic(
                ...
                signedby_address=bool(extrinsics_decoder.signed and extrinsic_data.get('account_id')),
                signedby_index=bool(extrinsics_decoder.signed and extrinsic_data.get('account_index')),
